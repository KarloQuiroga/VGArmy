...
<head>
	...
	<title>VGARMY</title>
     ...
     <!-- CSS PRINCIPAL -->
     <link rel="stylesheet" href="css/disenoformatoregister.css">
                 ...
                 <div class="col-md-offset-3 col-md-6 col-sm-1">
                       <div class="section-title">
                            <h1>REGISTRARSE</h1>
									...
									<form action="#" method="post" name="formularioregistrarse" class="online-form">
											 <input type="text" name="nombre" class="form-control" placeholder="Ingresa tu nombre" required><br></br>
											 <input type="email" name="email" class="form-control" placeholder="Ingresa tu email" required><br></br>
											 <input type="password" name="password" class="form-control" placeholder="Ingresa tu contraseña" required><br></br>
											 <button type="submit" name="registrarse" class="form-control" >Registrarse</button><br><br><br>
											 <a href="index.php" style='color: white'>¿Ya tienes cuenta? Iniciar sesión</a>
									</form>
