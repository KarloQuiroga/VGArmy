      ...
      <div class="row">
        <div class="col-md-6">
          <div class="block-web">
            <div class="header">
              ...
              <h3 class="content-header">Agregar productos</h3>
            </div>

            <div class="porlets-content">

              <form action="include/agregar1.php" name="formularioregisterp" method="post" enctype="multipart/form-data" class="form-horizontal row-border">

                <div class="form-group">
                  <label class="col-sm-3 control-label" >Nombre:</label>
                  <div class="col-sm-9">
                    <input type="text" name="nombre" class="form-control" maxlength="50" placeholder="Maximo 50 caracteres">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="desc" class="form-control" maxlength="600" placeholder="Maximo 600 caracteres">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="plataforma" class="form-control" maxlength="20" placeholder="Maximo 20 caracteres">
                  </div>
                </div>

                <div class="form-group">
                  <label class="col-sm-3 control-label">Lanzamiento:</label>
                  <div class="col-sm-9">
                    <input type="text" name="lanzamiento" class="form-control" maxlength="10" placeholder="Maximo 10 caracteres (dd/mm/yyyy)">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="editor" class="form-control" maxlength="50" placeholder="Maximo 50 caracteres">
                  </div>
                </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" name="genero" class="form-control" maxlength="50" placeholder="Maximo 50 caracteres">
                    </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="idioma" class="form-control" maxlength="50" placeholder="Maximo 50 caracteres">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="file" name="image" class="form-control" value="30000">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="precio" class="form-control" maxlength="13" placeholder="Maximo 13 caracteres">
                  </div>
                </div>

                <div class="form-group">
                  <label class="col-sm-3 control-label">Clasificación(Interna):</label>
                  <div class="col-sm-9">
                    <input type="text" name="clas" class="form-control" maxlength="1" placeholder="Maximo 1 caracter">
                  </div>
                </div>
        ...
        <div class="row">
           <div class="col-md-6">
             <div class="block-web">
               <div class="header">
                 <div class="actions"> <a class="minimize" href="#"><i class="fa fa-chevron-down"></i></a><a class="close-down" href="#"><i class="fa fa-times"></i></a> </div>
                 <h3 class="content-header">Eliminar productos</h3>
               </div>
               <div class="porlets-content">

                 <form action="include/borrarp.php" class="form-horizontal" method="post">
                   <div class="form-group">
        ...
        <div class="col-md-6">
          <div class="block-web">
            <div class="header">
              <div class="actions"> <a class="minimize" href="#"><i class="fa fa-chevron-down"></i></a><a class="close-down" href="#"><i class="fa fa-times"></i></a> </div>
              <h3 class="content-header">Editar productos</h3>
            </div>
            <div class="porlets-content">

              <form action="include/editarp.php" name="formularioeditar" method="post" class="form-horizontal row-border">

                <div class="form-group">
                  <label class="col-sm-3 control-label" >ID:</label>
                  <div class="col-sm-9">
                    <input type="text" name="id" class="form-control" maxlength="8" placeholder="Maximo 8 caracteres">
                  </div>
                </div>
       ...
       <div class="row">
         <div class="col-md-6">
           <div class="block-web" style="width: 205% !important">
             <div class="header">
               <div class="actions"> <a class="minimize" href="#"><i class="fa fa-chevron-down"></i></a><a class="close-down" href="#"><i class="fa fa-times"></i></a> </div>
               <h3 class="content-header">Consulta productos</h3>
             </div>
                   ...
                   <table  class="display table table-bordered table-striped" id="dynamic-table">
                     ...
                     <tbody>
                       ...
                       <tr class="gradeX">
                         ...
                         <td><img src="data:image/jpg; base64,<?=base64_encode($consulta['imagen'])?>" style="width: 100% !important"></td>
...
<?php include ("include/cerrarconexion.php"); ?>
